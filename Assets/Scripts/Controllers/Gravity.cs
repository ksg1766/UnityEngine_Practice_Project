...
public class Gravity : MonoBehaviour
{
    ...
    void Update()
    {
        if (Physics.Raycast(transform.position + height, Vector3.down, out hit[0], float.MaxValue, layerMask))
        {
            ...
            Physics.Raycast(transform.position + height + new Vector3(extents.x, 0, extents.z), Vector3.down, out hit[5], float.MaxValue, layerMask);
            Physics.Raycast(transform.position + height + new Vector3(-extents.x, 0, extents.z), Vector3.down, out hit[6], float.MaxValue, layerMask);
            Physics.Raycast(transform.position + height + new Vector3(extents.x, 0, -extents.z), Vector3.down, out hit[7], float.MaxValue, layerMask);
            Physics.Raycast(transform.position + height + new Vector3(-extents.x, 0, -extents.z), Vector3.down, out hit[8], float.MaxValue, layerMask);
            ...
            Debug.DrawRay(transform.position + height + new Vector3(0, 0, -extents.z), Vector3.down, Color.green);
            Debug.DrawRay(transform.position + height + new Vector3(extents.x, 0, extents.z), Vector3.down, Color.green);
            Debug.DrawRay(transform.position + height + new Vector3(-extents.x, 0, extents.z), Vector3.down, Color.green);
            Debug.DrawRay(transform.position + height + new Vector3(extents.x, 0, -extents.z), Vector3.down, Color.green);
            Debug.DrawRay(transform.position + height + new Vector3(-extents.x, 0, -extents.z), Vector3.down, Color.green);

            float distance = (hit[0].distance + hit[1].distance + hit[2].distance + hit[3].distance + hit[4].distance + hit[5].distance + hit[6].distance + hit[7].distance + hit[8].distance) / 9.0f;
            //Debug.Log(distance);
            ...
            {
                transform.Translate(new Vector3(0, 1.1f, 0) - new Vector3(0, distance, 0));
            }
        }
        else
        {
