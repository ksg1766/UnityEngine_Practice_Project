...
public class WeaponShop : UI_Base //MonoBehaviour
{
    PlayerStat _stat;
    ...
    public void SelectItem()
    {
        ...
        foreach (KeyValuePair<string, int> item in SelectedList)
        {
            ...
            GameObject iconImage = GameObject.Find($"Selected Item {selected_list_count}").transform.Find($"weaponshop_selected{selected_list_count}").gameObject;
