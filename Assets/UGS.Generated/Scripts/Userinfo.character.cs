...
namespace Userinfo
{
    ...
    { 
        ...
        static string sheetID = "1442067667"; // it is sheet id
...
#region fuctions
        ...
        public static void Load(bool forceReload = false)
        {
            ...
            {
#if UGS_DEBUG
                 Debug.Log("character is already loaded! if you want reload then, forceReload parameter set true");
#endif
                 return;
            }
    ...
    public static (List<character> list, Dictionary<string, character> map) CommonLoad(Dictionary<string, Dictionary<string, List<string>>> jsonObject, bool forceReload){
            ...
            var sheet = jsonObject["character"];
        ...
        public static void Write(character data, System.Action<WriteObjectResult> onWriteCallback = null)
        { 
            TypeMap.Init();
            FieldInfo[] fields = typeof(character).GetFields(BindingFlags.Public | BindingFlags.Instance);
