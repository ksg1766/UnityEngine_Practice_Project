...
namespace UGS.Editor
{
    public class GoogleDriveExplorerGUI : EditorWindow
    {
        ...
        { 
            ...
            {
                EditorUtility.DisplayDialog("Security Mode Enabled..", "Security Mode Enabled, So All Google Drive API Disabled... If you want use Google Drive Explorer Please Disable Security Mode.", "OK");
                return;
            }
            ...
            {
                EditorUtility.DisplayDialog("Require Setting!", " Cannot Open UGS Menu. Please Setting Complete!", "OK");
                return;
            }
